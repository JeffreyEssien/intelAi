...
export default function Page4() {
    return(
        <div className='text-[#8A8A8A] bg-[#0D0D0D] flex flex-col items-center mt-36'>
            ...
            <p className='text-center w-[50%] text-[16px]'>Explore the frontier of coding evolution with Glossy Unleashed. Our latest features redefine the boundaries of what's possible in coding tools.</p>  

            <div className='flex flex-row '>
                <div className='w-1/2'>
                    <Image src={StickerImage} alt='image' className='w-[7%]'/>
