...
export default function Page3() {
    ...
    return(
        <div className="bg-[#0D0D0D] text-[#8A8A8A] flex flex-col items-center pt-20 bg-gradient relative overflow-hidden">
            ...
            <p className="lg:text-[24px] text-[16px] text-center lg:w-[45%] w-[80%] mb-10">Intel AI leverages a custom LLM architecture that's fine-tuned to grasp the intricacies of blockchain technology, its narratives, trends, & community nuances with unparalleled precision</p>
