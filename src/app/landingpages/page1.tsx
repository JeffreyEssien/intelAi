...
<Image src={Overlay} alt='Overlay' className='absolute bottom-0 left-1/2 transform -translate-x-1/2' />
      ...
      <div className="w-[100%] mx-auto flex flex-col items-center justify-center">
        <p className=" leading-tight lg:text-[64px] text-center w-[80%] bg-gradient-to-r from-[#03FFA3] via- to-[#7F56D9] text-transparent mb-5 flex flex-col font-semibold" style={bgClipText}>Communication Protocol of <span className=''>Blockchain AI Agents</span></p>
        ...
        <div className="bg-gradient-to-r from-[#03FFA3] to-[#7F56D9] rounded-[66px] py-[2px] px-[2px] mb-10 shadow-xl shadow-[#BDFE1C1A]">
          <button className="flex gap-2 bg-gradient-to-r from-[#3A3A3A] to-[#000000] rounded-[66px] py-4  px-40">Request Early Access <span className="text-[#03FFA3]"><svg width="6" height="7" viewBox="0 0 6 7" fill="none" xmlns="http://www.w3.org/2000/svg">
