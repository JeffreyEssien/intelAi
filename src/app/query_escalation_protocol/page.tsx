        ...
        <div className="flex flex-row min-h-screen w-full">
            ...
            <div className="bg-[#0D0D0D] w-full h-auto flex flex-col">
                <div className="w-full flex flex-row items-center p-8 gap-4">
                    <Link href='community_ai_training' className="text-[#6A6A6A] text-[14px]">Ai Training</Link>
                ...
                <div className="min-h-screen w-full bg-[#131313] rounded-t-[20px] flex flex-col justify-center items-center relative">
                    ...
                    <div className="lg:w-1/2 h-auto flex flex-col items-center justify-center">
                        <p className="text-[32px] font-medium text-white">No information here</p>
                        <Image src={BoxImage} alt="box" className="w-[35%]" />
                        <p className="text-[#707070] text-[14px] lg:w-[45%] w-[90%] text-center mt-3">Once your community is set up, cases that the aI can’t assess would be pushed here</p>
                    </div>
                    <button onClick={handleEscalationReport} className="bg-white rounded-[24px] lg:w-1/6 w-[90%] py-3 mt-8 text-black text-[12px]">Integrate community</button>
                </div>
            </div>
        </div>
    )
