...
export default function ActivitesCommunity() {
    ...
    return (
        <div className='w-full h-auto bg-[#181818] flex flex-col py-2 rounded-[20px] px-6'>
            ...
            <div className='flex flex-row justify-between'>
                <div className='w-[15%]'>
                    <p className='text-[40px] mt-5 mb-2'>20</p>
                    <p className='text-[#969696] text-[14px]'>Total escallations across all platforms</p>
                </div>
                <ResponsiveContainer width="85%" height={200} className="bg-[#1C1C1C]">
                    <BarChart data={data}>
                        <XAxis dataKey="name" />
                        <YAxis />
                        <Tooltip />
                        <Bar dataKey="pv" fill="#0EA5E9" />
                        <Bar dataKey="uv" fill="#2DB253" />
                        <Bar dataKey="amt" fill="#6043A3" />
                    </BarChart>
                </ResponsiveContainer>
            </div>
        </div>
