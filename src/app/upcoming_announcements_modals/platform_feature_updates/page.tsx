        ...
        <div className="absolute flex items-center justify-center bg-[#0A0908] bg-opacity-50 w-full h-screen z-20">
            <div className="bg-[#101010] rounded-[20px] w-1/3">
                ...
                <div className="bg-[#1B1B1B] px-10 rounded-b-[20px]">
                    ...
                    <p className="flex flex-col text-[14px] pb-3 ">Please provide detailed information about the new partnership. Include the:
                ...
                <div className="bg-[#131313] pt-10 px-5 border-b border-[#131313]">
                    ...
                    <div className="w-full px-4 flex justify-between border-t py-3 border-[#363636] bg-[#0D0D0D] rounded-b-[20px]">
                        ...
                        <button className="ml-2 p-2 bg-[#03FFA3] rounded-lg" >
                            <AiOutlineSend size={24} />
                        </button>
                    </div>
                </div>
                <div className="bg-[#131313] flex justify-center items-center py-5 rounded-[20px]">
                    <button className="bg-gradient-to-r from-[#03FFA3] to-[#7F56D9] px-14 py-3 rounded-[20px]">Save</button>
                </div>
            </div>
