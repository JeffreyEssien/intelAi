...
export default function ScheduledPlatformMaintenance() {
    ...
    return (
        <div className=" flex items-center justify-center bg-[#0A0908] bg-opacity-50 w-full h-screen z-20">
            <div className="bg-[#101010] rounded-[20px] w-1/3">
                <p className="p-5 border-b border-[#181818]">Scheduled Platform Maintenance or Upgrades</p>
                ...
                <div className="bg-[#1B1B1B] px-10 rounded-b-[20px]">
                    ...
                    <p className="flex flex-col text-[14px] pb-3 ">Provide information about the scheduled maintenance or upgrade.  Include:
                        <li className="text-[#535353] pl-3">What will be affected</li>
                        <li className="text-[#535353] pl-3">The start and end time</li>
                        <li className="text-[#535353] pl-3">Expected Impacts</li>
                        <li className="text-[#535353] pl-3"> And, any actions users need to take</li>
                    </p>
                </div>
                </div>
