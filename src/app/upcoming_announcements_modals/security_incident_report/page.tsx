    ...
    return (
        <div className=" flex items-center justify-center bg-[#0A0908] bg-opacity-50 w-full h-screen z-20">
            <div className="bg-[#101010] rounded-[20px] w-1/3">
                <p className="p-5 border-b border-[#181818]">Security Incident Report</p>
                ...
                <div className="bg-[#1B1B1B] px-10 rounded-b-[20px]">
                    ...
                    <p className="flex flex-col text-[14px] pb-3 ">Report a security incident. Describe:

                        <li className="text-[#535353] pl-3">What happened.</li>
                        <li className="text-[#535353] pl-3">When it occurred & the date you want it published".</li>
                        <li className="text-[#535353] pl-3">How it was resolved.</li>
                        <li className="text-[#535353] pl-3">And, steps taken to prevent future incidents.</li>
                    </p>
                </div>
                </div>
