  ...
  return (
    <div className="flex items-center justify-center bg-[#0A0908] bg-opacity-50 h-screen z-10">
      <div className="bg-[#101010] rounded-[20px] w-1/3">
        <p className="p-5 border-b border-[#181818]">Partnership Announcement</p>
        <div className="bg-[#131313] flex flex-col items-center px-8">
          <p className="italic text-[14px] pt-4 mb-2">
            When do you want to inform your community about this information?
          </p>
          ...
          <button
            className="underline w-full text-right text-[#BDFE1C] text-[12px] pt-2 pb-10"
            onClick={handleCalendarToggle}
          >
            Custom day
          </button>
          {state.showCalendar && <CalendarWidget />}
        </div>
        <div className="bg-[#1B1B1B] px-10 rounded-b-[20px]">
          <p className="py-4">Instructions:</p>
          <p className="flex flex-col text-[14px] pb-3">
            Please provide detailed information about the new partnership.
            Include the:
            <li className="text-[#535353] pl-3">Partner's name.</li>
            <li className="text-[#535353] pl-3">The objective of the partnership.</li>
            <li className="text-[#535353] pl-3">The date of the announcement.</li>
            <li className="text-[#535353] pl-3">How it benefits the project.</li>
          </p>
        </div>
        <div className="bg-[#131313] pt-10 px-4 border-b border-[#131313]">
          <textarea
            ...
            onChange={(e) =>
              setState((prevState) => ({ ...prevState, textAreaValue: e.target.value }))
            }
          />
        ...
        <div className="bg-[#131313] flex justify-center items-center py-5 rounded-[20px]">
          <button
            className="bg-gradient-to-r from-[#03FFA3] to-[#7F56D9] px-14 py-3 rounded-[20px]"
            type="submit"
