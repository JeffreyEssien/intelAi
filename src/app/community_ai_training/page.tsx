                ...
                <div className="flex flex-col items-center w-full">
                    ...
                    <div className="bg-[#141414] rounded-[20px] min-h-screen w-full flex flex-col">
                        ...
                        <div className="mt-20 flex flex-col w-[80%] mx-auto">
                            ...
                            <button className="bg-gradient-to-r from-[#03FFA3] to-[#7F56D9] w-[222px] mx-auto mt-8 py-2   text-white rounded-[21px] flex flex-row items-center gap-2 justify-center"><span className="text-center"><FaTelegramPlane /></span>Simulate on Telegram</button>
                        </div>
