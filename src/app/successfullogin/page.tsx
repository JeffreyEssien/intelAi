...
export default function SuccessfulLogin() {
    ...
    return (
        <div className="h-screen flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="rounded-full bg-[#141414] w-[190px] h-[190px] flex items-center justify-center z-20">
                <div className="bg-gradient-to-r from-[#03FFA3] to-[#7F56D9] rounded-full w-[120px] h-[120px] flex items-center justify-center">
                    <div className="rounded-full bg-[#141414] w-[118px] h-[118px] flex items-center justify-center">
                        <p><svg width="50" height="35" viewBox="0 0 50 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-white text-[40px]">Onboarded Successfully</p>
            <p className="text-[#707070] text-14px">Your info has been uploaded to the AI, you can begin testing your AI now</p>

            <button className="text-center text-black bg-white py-3 w-[12%] rounded-[60px] mt-10 hover:opacity-45">Go To Dashboard</button>
        </div>
    )
}