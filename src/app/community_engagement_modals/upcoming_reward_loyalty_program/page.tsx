...
export default function UpcomingRewardLoyaltyProgram() {
    ...
    return (
        <div className=" flex items-center justify-center bg-[#0A0908] bg-opacity-50 w-full h-screen z-20">
            <div className="bg-[#101010] rounded-[20px] w-1/3">
                <p className="p-5 border-b border-[#181818]">⁠Upcoming Reward & Loyalty Program</p>
                ...
                <div className="bg-[#1B1B1B] px-10 rounded-b-[20px]">
                    <p className="py-4 flex items-center">Instructions: </p>
                    <p className="flex flex-col text-[14px] pb-3 ">Please provide detailed information about the Upcoming Contests and Giveaways Include the:
