...
export default function Sidebar() {
    ...
    const noSidebarPaths = ["/intel_ai_workspace"]
        ...
        return (
            ...
            >
                ...
                <div className='items flex flex-col space-y-14'>
                    <Link href='/communitydashboard'><div className='flex flex-row items-center gap-3 justify-center'>
                        <p className={sidebarWidthCollapsed === '20%' ? ' pl-14' : ''}><svg width="22" height="22" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link href='/intel_ai_workspace'><div className='flex flex-row items-center gap-3 justify-center'>
                        ...
                        {sidebarWidthCollapsed === '20%' && (
                            <p className='text-[14px]'>AI Community Workspace</p>
                        )}
                    </div>
                    </Link>
                    ...
                    <div className=''>
                        <p className='text-[#707070] text-center text-[12px]'>DEPIN </p>
                    </div>
                    {sidebarWidthCollapsed && (
                        <div>
                            <p className='text-center text-[#3F3F3F] text-[14px] mb-5'>SETTINGS</p>
